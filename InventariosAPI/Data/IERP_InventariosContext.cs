...
{
    public partial class IERP_InventariosContext : DbContext
    {
        public IERP_InventariosContext()
        {
        }

        public IERP_InventariosContext(DbContextOptions<IERP_InventariosContext> options)
            : base(options)
        {
        }
        ...
        /*added 24/12/2021*/
        public DbSet<Cveprodservcp> Cveprodservcp { get; set; }
        /*added 24/12/2021*/
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<InLineaproducto>(entity =>
            {
                entity.HasKey(e => e.LineaProductoId)
                    .HasName("PK__IN_LINEA__A0B9DF9117F946E8");
            ...
            modelBuilder.Entity<Cveunidad>(entity =>
            {
                entity.HasKey(e => e.ClaveUnidadId)
                    .HasName("PK__CVEUNIDA__7CEED68F57C1607C");
            ...
            modelBuilder.Entity<Cveprodservcp>(entity =>
            {
                ...
                entity.HasIndex(e => e.MaterialPeligrosoId)
                    .HasName("ICVEPRODSERVCP1");
